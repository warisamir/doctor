import startIcon from './../../assets/Image/Star.png';
  ...
  return (
    <div>
        ...
        <div className="mt-2 lg:mt-2 flex items-center justify-between">
            <span className='bg-[#CCF0F3] text-irisBlueColor py-1 px-2 lg:py-2 lg:px-6 text-[12px] lg:text-[16px] font-semibold lg:leading-7 rounded'>{specialization}</span>
